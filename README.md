...
<p align="center">
  CS grad @ UVA → incoming MSE Scalable Systems @ Carnegie Mellon (Fall 2026)<br/>
...
<!-- Add/remove badges to match what you're actually competent in. Full icon list: https://github.com/inttter/md-badges -->
